...
export default function App() {
  ...
  return (
    ...
    <div className="min-h-screen font-nunito overflow-x-hidden" style={{ background: C.ivory, color: C.carbon }}>
      ...
      {/* ════════ HERO ════════ */}
      {route === 'home' && (<>
      <section className="hero-grid relative min-h-[100svh] flex items-start lg:items-center overflow-hidden pt-16" style={{ background: C.ivory }}>
        <Particles />
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 w-full min-w-0 pt-4 pb-10 sm:py-20 grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 items-center lg:items-start min-[1300px]:items-center relative z-10">
